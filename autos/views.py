...
class MakeCreate(LoginRequiredMixin, CreateView):#View):
    model = Make
    fields = '__all__'
...
class MakeUpdate(LoginRequiredMixin, UpdateView):#View):
    model = Make
...
class MakeDelete(LoginRequiredMixin, DeleteView):#View):
    model = Make
    fields = '__all__'
    success_url = reverse_lazy('autos:all')
